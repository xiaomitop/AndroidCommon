package com.common.recyclerview.refresh;
...
public abstract class PullBaseView<T extends RecyclerView> extends LinearLayout {
    ...
    private void addHeaderView() {
        ...
        mHeaderImageView = mHeaderView.findViewById(R.id.iViewPullToRefreshImage);
        mHeaderTextView = mHeaderView.findViewById(R.id.tViewPullToRefreshText);
        mHeaderUpdateTextView = mHeaderView.findViewById(R.id.tViewPullToRefreshUpdatedDate);
        mHeaderProgressBar = mHeaderView.findViewById(R.id.pBarPullToRefreshProgress);
    ...
    private void addFooterView() {
        ...
        mFooterTextView = mFooterView.findViewById(R.id.tViewPullToLoadText);
        mFooterProgressBar = mFooterView.findViewById(R.id.pBarPullToLoadProgress);

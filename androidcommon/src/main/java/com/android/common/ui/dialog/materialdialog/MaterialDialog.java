...
public class MaterialDialog {
    ...
    private Button mPositiveButtonOrdinary;
    private LinearLayout.LayoutParams mLayoutParams;
    private Button mNegativeButton;
    private Button mNegativeButtonOrdinary;
    ...
    public MaterialDialog setPositiveButton(int resId, final DialogOnClickListener listener) {
        this.pId = resId;
    ...
    public Button getPositiveButton() {
        if (isOrdinary) {
            return mPositiveButtonOrdinary;
        } else {
    ...
    public Button getNegativeButton() {
        if (isOrdinary) {
            return mNegativeButtonOrdinary;
        } else {
    ...
    public MaterialDialog setPositiveButton(String text, final DialogOnClickListener listener) {
        this.pText = text;
        this.pListener = listener;
        return this;
    }
    ...
    public MaterialDialog setNegativeButton(int resId, final DialogOnClickListener listener) {
        this.nId = resId;
    ...
    public MaterialDialog setNegativeButton(String text, final DialogOnClickListener listener) {
        this.nText = text;
        this.nListener = listener;
        return this;
    }
    ...
    public MaterialDialog isOrdinary(boolean isOrdinary) {
    ...
    private class Builder {
        ...
        private LinearLayout mButtonLayoutOrdinary;
        ...
        private Builder() {
            ...
            View contentView = LayoutInflater.from(mContext)
                    .inflate(R.layout.dialog_layout_material_dialog, null);
            contentView.setFocusable(true);
            contentView.setFocusableInTouchMode(true);

            mAlertDialogWindow.setBackgroundDrawableResource(R.drawable.dialog_material_dialog_window);
            ...
            mButtonLayoutOrdinary = (LinearLayout) mAlertDialogWindow.findViewById(R.id.buttonLayout_ordinary);
            mButtonLayout = (LinearLayout) mAlertDialogWindow.findViewById(R.id.buttonLayout);
            if (isOrdinary) {
                mTitleView.setGravity(Gravity.CENTER);
                mPositiveButtonOrdinary = (Button) mButtonLayoutOrdinary.findViewById(R.id.btn_p_ordinary);
            ...
            if (pId != -1) {
                if (isOrdinary) {
                    mPositiveButtonOrdinary.setVisibility(View.VISIBLE);
                    mPositiveButtonOrdinary.setText(pId);
                    mPositiveButtonOrdinary.setOnClickListener(new View.OnClickListener() {
                        @Override
                    ...
                    if (isLollipop()) {
                        mPositiveButtonOrdinary.setElevation(0);
                    }
                } else {
            ...
            if (nId != -1) {
                if (isOrdinary) {
                    mNegativeButtonOrdinary.setVisibility(View.VISIBLE);
                    mNegativeButtonOrdinary.setText(nId);
                    mNegativeButtonOrdinary.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                    ...
                    if (isLollipop()) {
                        mNegativeButtonOrdinary.setElevation(0);
                    }
                } else {
            ...
            if (!isNullOrEmpty(pText)) {
                if (isOrdinary) {
                    mPositiveButtonOrdinary.setVisibility(View.VISIBLE);
                    mPositiveButtonOrdinary.setText(pText);
                    mPositiveButtonOrdinary.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            pListener.onClick(view);
            ...
            if (!isNullOrEmpty(nText)) {
                if (isOrdinary) {
                    mNegativeButtonOrdinary.setVisibility(View.VISIBLE);
                    mNegativeButtonOrdinary.setText(nText);
                    mNegativeButtonOrdinary.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            nListener.onClick(view);
            ...
            if (isNullOrEmpty(pText) && pId == -1) {
                if (isOrdinary) {
                    mPositiveButtonOrdinary.setVisibility(View.GONE);
            ...
            if (isNullOrEmpty(nText) && nId == -1) {
                if (isOrdinary) {
                    mNegativeButtonOrdinary.setVisibility(View.GONE);
                    imgLine.setVisibility(View.GONE);
                } else {
        ...
        /**
         * set positive dialog_button
         *
         * @param text the name of dialog_button
         */
